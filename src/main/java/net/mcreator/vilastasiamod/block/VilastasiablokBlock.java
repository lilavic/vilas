...
package net.mcreator.vilastasiamod.block;
...
public class VilastasiablokBlock extends VilastasiaModModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(4f, 30f).setLightLevel(s -> 0).harvestLevel(3)
